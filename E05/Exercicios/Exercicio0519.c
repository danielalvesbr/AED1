...
void method_01 ( void )
{
    ...
    int cont = 0;
    int soma = 0;
    int termo = 4;  // termo diferente de zero para desconsiderar o zero na 
    int termo1 = 0;
    int resposta[100];
...
int main ( )
{
    ...
    {
        // identificar
        printf( "EXERCICIO0519 - Programa - v0.0" );
        printf("\nAutor: Daniel Alves Goncalves");
        // ler do teclado
        printf ( "\n%s\n","Opcoes" );
        printf ( "\n%s","0 - Parar");
