...
void method_01 ( void )
{
    ...
    {                            // criar a repeticao para gravar no arranjo
        if ((termo % 4 == 0) && (termo % 3 == 0)) // se divisivel por 4 ou 3
        {  
            resposta[cont] = termo;
            termo = termo + 1;
            cont = cont + 1;
...
int main ( )
{
    ...
    {
        // identificar
        printf( "EXERCICIO0512 - Programa - v0.0" );
        printf("\nAutor: Daniel Alves Goncalves");
        // ler do teclado
        printf ( "\n%s\n","Opcoes" );
        printf ( "\n%s","0 - Parar");
...
Pede uma quantidade, e cria um intervalo com multiplos de dois valores definidos.
---------------------------------------------- previsao de testes
n = 5 => { 12, 24, 36, 48, 60 }
---------------------------------------------- historico
