...
int main ( )
{
    ...
    {
        // identificar
        IO_id ( "EXEMPLO0507 - Programa - v0.0" );
        // ler do teclado
        IO_println ( "Opcoes" );
        IO_println ( "0 - Parar" );
...
Mostrar a soma +1 (de fracoes) dos valores -1(x-1) dividido por certa quantidade 
de valores(x) de 2 em 2 (pares).
---------------------------------------------- previsao de testes
a.) 5 
---------------------------------------------- historico
