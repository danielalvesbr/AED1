...
int main ( )
{
    ...
    {
        // identificar
        IO_id ( "EXEMPLO0509 - Programa - v0.0" );
        // ler do teclado
        IO_println ( "Opcoes" );
        IO_println ( "0 - Parar" );
        ...
        IO_println ( "10 - Mostrar o produto dos pares de certa quantidade de valores pares" );
        IO_println ( "" );
...
Mostrar o produto dos pares de certa quantidade de valores pares
---------------------------------------------- previsao de testes
a.) 5 
---------------------------------------------- historico
