...
printf ( "\n" );
printf ( "MATRICULA: 874770 ALUNO : Daniel Alves Goncalves" );
printf ( "\nPRESSIONAR <Enter> PARA TERMINAR." );
getchar( );
return ( EXIT_SUCCESS );
}
...
printf ( "\nMATRICULA: 874770 ALUNO : Daniel Alves Goncalves" );
printf ( "\nEXEMPLOS DE VALORES : " );
printf ( "\nCARACTERE : %c",'A' );
printf ( "\nINTEIRO: %d",
10 );
...
O código consiste em 50 funções, cada qual ensina uma coisa diferente
---------------------------------------------- previsao de testes
N/D
---------------------------------------------- historico
Versao      Teste
0.1          08. ( OK ) Implementacao dos metodos
0.2          01. ( OK ) Ajustes nos printf e espacos
