...
int main ( )
{
    ...
    {
        // identificar
        IO_id ( "EXEMPLO0409 - Programa - v0.0" );
        // ler do teclado
        IO_println ( "Opcoes" );
        IO_println ( "0 - Parar" );
        ...
        IO_println ( "9 - Ler palavra, contar e mostrar os algarismos" );
        IO_println ( "10 - Ler palavra, contar e mostrar os algarismos [sequencia assim]" );
        IO_println ( "" );
...
Pede uma palavra, conta e retorna os algarismos [neste formato em sequencia]!
---------------------------------------------- previsao de testes
a.) Te5t4nd0
---------------------------------------------- historico
