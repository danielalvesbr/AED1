...
int main(int argc, char** argv) {
    int x = 0;
    do {
        cout << "EXEMPLO11 - Programa - v0.0\n " << endl;
        cout << "Opcoes " << endl;
        cout << " 0 - Parar o programa" << endl;
        cout << " 1 - Mostrar dados inteiros em arranjo" << endl;
        cout << " 2 - Ler dados inteiros do teclado e mostrar" << endl;
        cout << " 3 - Ler dados de um arquivo e mostrar" << endl;
        cout << " 4 - Gravar dados em um arquivo" << endl;
        cout << " 5 - Copiar dados de um arranjo para outro" << endl;
        cout << " 6 - Testar copia com construtor de copia" << endl;
        cout << " 7 - Testar copia com sobrecarga de operador" << endl;
        cout << " 8 - Mostrar exemplo de uso de arquivos com arranjo" << endl;
        cout << " 9 - Mostrar operacoes adicionais com arranjo" << endl;
        cout << "10 - Exibir informacoes gerais do programa" << endl;

        cout << endl << "Entrar com uma opcao: ";
        cin >> x;

        switch (x) {
            case 0:  method_01(); break;
