...
int main()
{
    ...
    {
        // identificar
        IO_id("EXEMPLO0S 09 - Programa - v0.0");
        // ler do teclado
        IO_println("Opcoes");
        IO_println("0 - Parar");
        IO_println("1 - Demonstra o uso de uma matriz predefinida");
        IO_println("2 - Solicita ao usuario uma matriz 2x2, le e imprime");
        IO_println("3 - Le uma matriz de tamanho especificado pelo usuario, imprime e grava em um arquivo");
        IO_println("4 - Le uma matriz de um arquivo e imprime");
        IO_println("5 - Copia uma matriz de um array para outo e imprime ambos");
        IO_println("6 - Transpoe uma matriz e imprime o resultado");
        IO_println("7 - Verifica se as matrizes sao matrizes identidade e imprime o resultado");
        IO_println("8 - Compara duas matrizes pela igualdade e imprime o resultado");
        IO_println("9 - Multiplica duas matrizes e imprime o resultado");
        IO_println("10 - Determina o determinante de uma matriz 2x2 e imprime");
        IO_println("");
