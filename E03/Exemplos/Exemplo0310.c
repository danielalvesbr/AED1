...
Faz uma coluna com um incremento dos numeros a partir do numero inferior inserido (crescente) ate o numero superior inserido
Alem disso a variacao depende do passo que e inserido pelo usuario 
Toda vez que um valor invalido e inserido o programa desconsidera e pergunta novamente
---------------------------------------------- previsao de testes
a.) [ 0.1 : 0.5 ] e passo = 0.1     OK
b.) [ 0.5 : 0.1 ] e passo = -0.1    Fail (invalido)
c.) [ 0.5 : 0.1 ] e passo = 0.1     Fail (invalido)
d.) [ 0.1 : 0.5 ] e passo = -0.1    Fail (invalido)
---------------------------------------------- historico
