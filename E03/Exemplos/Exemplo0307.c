...
int main ( )
{
    ...
    do
    {
        ...
        switch ( x )
        {
            ...
            default:
            IO_pause ( IO_concat ( "Valor diferente das opcoes [0,1,2,3,4,5,6,7] (",
...
Retirei o int x = 0; da l172, pois o mesmo nao estava sendo utilizado
---------------------------------------------- notas / observacoes / comentarios
Faz uma coluna com um incremento dos numeros a partir do 1 ate o numero inserido (decrescente) na quantidade
