...
int main ( )
{
    ...
    {
        // identificar
        printf( "EXEMPLO0312 - Programa - v0.0" );
        printf("\nAutor: Daniel Alves Goncalves");
        // ler do teclado
        printf ( "\n%s\n","Opcoes" );
        printf ( "\n%s","0 - Parar");
        printf ( "\n%s","1 - Repeticao com teste no inicio (maiusculas)" );
        printf ( "\n%s","2 - Repeticao com teste no inicio (minusculas)" );
        printf ( "\n" );
...
Mostra os caracteres minusculos da palavra digitada em uma coluna
---------------------------------------------- previsao de testes
palavra = "PaLaVrA"
---------------------------------------------- historico
