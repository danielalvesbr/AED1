...
int main ( )
{
    ...
    {
        // identificar
        printf( "EXEMPLO0317 - Programa - v0.0" );
        printf("\nAutor: Daniel Alves Goncalves");
        // ler do teclado
        printf ( "\n%s\n","Opcoes" );
        printf ( "\n%s","0 - Parar");
        ...
        switch ( x )
        {
            ...
            default:
                printf ("\nValor diferente das opcoes [0,1,2,3,4,5,6,7] (%d)\n\n",x ); break;
        } // end switch
    }
    while ( x != 0 );
    // encerrar
...
quantidade de multiplos de 5 dentro do intervalo definido
---------------------------------------------- previsao de testes
[a,b]=[15:60] respectivamente, e n = 7, com { 10, 20, 30, 42, 54, 60, 84 }
---------------------------------------------- historico
