...
int main ( )
{
    ...
    {
        // identificar
        printf( "EXEMPLO0319 - Programa - v0.0" );
        printf("\nAutor: Daniel Alves Goncalves");
        // ler do teclado
        printf ( "\n%s\n","Opcoes" );
        printf ( "\n%s","0 - Parar");
...
Le 2 limites (inferior e superior) com confirmacao respectivamente, e a quantidade de testes, depois conta e mostra 
quantidade de numeros com a parte inteira dentro do intervalo definido
---------------------------------------------- previsao de testes
[a,b]=(2.5:7.8), e n = 7, com { 1.0, 2.4, 3.3, 4.1, 5.5, 6.3, 8.4 }
---------------------------------------------- historico
