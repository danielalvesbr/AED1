/*
	Exemplo0204 - v0.0. - 03 / 09 / 2024
	Autor: Daniel Alves Goncalves
	
	Para compilar:
	gcc -o exemplo0204 exemplo0204.c
	exemplo0204
*/
...
Programa rodou de primeira, na hora de digitar retirei o ponto de .// da l156 e coloquei ; na l132
---------------------------------------------- notas / observacoes / comentarios
Em caso 4 exibe o nome do autor e pede para digitar um numero real e indicar se: 
Esta dentro ou fora da marcacao de 1.0 a 10.0 definida e se esta acima de 10.0 ou abaixo de 1.0.
---------------------------------------------- previsao de testes
---------------------------------------------- historico
...
---------------------------------------------- testes
Versao Teste
0.0 00. ( Exemplo0204 ) identificacao de programa
*/