/*
	Exemplo0206 - v0.0. - 03 / 09 / 2024
	Autor: Daniel Alves Goncalves
	
	Para compilar:
	gcc -o exemplo0206 exemplo0206.c
	exemplo0206
*/
...
Programa rodou de primeira, na hora de digitar retirei o ponto de .// da l220 e coloquei ; na l195
---------------------------------------------- notas / observacoes / comentarios
Em caso 6 exibe o nome do autor e pede para digitar um caractere e exibe se:
O caractere e letra ou nao.
---------------------------------------------- previsao de testes
---------------------------------------------- historico
...
---------------------------------------------- testes
Versao Teste
0.0 00. ( Exemplo0206 ) identificacao de programa
*/