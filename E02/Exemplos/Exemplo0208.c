/*
	Exemplo0208 - v0.0. - 03 / 09 / 2024
	Autor: Daniel Alves Goncalves
	
	Para compilar:
	gcc -o exemplo0208 exemplo0208.c
	exemplo0208
*/
...
Em caso 8 exibe o nome do autor e pede para digitar um caractere entre '0','A' e 'a' e:
Mostra o respectivo valor em ASCII.
---------------------------------------------- previsao de testes
---------------------------------------------- historico
...
---------------------------------------------- testes
Versao Teste
0.0 00. ( Exemplo0208 ) identificacao de programa
*/