/*
	Exemplo0207 - v0.0. - 03 / 09 / 2024
	Autor: Daniel Alves Goncalves
	
	Para compilar:
	gcc -o exemplo0207 exemplo0207.c
	exemplo0207
*/
...
Programa rodou de primeira, na hora de digitar retirei o ponto de .// da l246 e coloquei ; na l220
---------------------------------------------- notas / observacoes / comentarios
Em caso 7 exibe o nome do autor e pede para digitar um caractere e exibe se:
O caractere e letra ou nao, testando se nao e primeiro.
---------------------------------------------- previsao de testes
---------------------------------------------- historico
...
---------------------------------------------- testes
Versao Teste
0.0 00. ( Exemplo0207 ) identificacao de programa
*/